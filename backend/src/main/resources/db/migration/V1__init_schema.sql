...
CREATE TABLE IF NOT EXISTS `alert_history` (
    ...
    `channel_type` VARCHAR(100) NOT NULL COMMENT '通知渠道: EMAIL/WEBHOOK/DINGTALK/WECOM，多个渠道用逗号分隔',
...
(UUID(), 'alert_config', 'approval_expiration_minutes', '60', '审批记录过期时间（分钟）', FALSE),
